...
//		Font exitGameFont = Font.font("Impact", FontWeight.BOLD, 30);
//		exitGame.setFont(exitGameFont);
//		root.add(exitGame, 720, 100);
    ...
    public void setExitGame(GridPane root) {
        Button exitGame = new Button("Exit Game");
        Font exitGameFont = Font.font("Impact", FontWeight.BOLD, 30);
        exitGame.setFont(exitGameFont);

        root.add(exitGame, 0, HEIGHT + 2, WIDTH, 1);
